    ...
    var FileProgressBarHandler = (function() {
        function handle(connection) {
            ...
            connection.onFileStart = function(file) {
                ...
                div.title = file.name;
                div.innerHTML = '<label>0% of ' + hf(file.size) + '</label> <progress></progress>';
            ...
            connection.onFileEnd = function(file) {
                ...
                if (file.type.indexOf('image') != -1) {
                    div.innerHTML = '<a href="' + file.url + '" download="' + file.name + '">Download ' + file.name + '   ' + hf(file.size) + '</a><br /><img src="' + file.url + '" title="' + file.name + '" style="max-width: 80%;">';
                } else {
                    div.innerHTML = '<a href="' + file.url + '" download="' + file.name + '">Download '  + file.name + '   ' + hf(file.size) + '</a><br />';
                }
            };
